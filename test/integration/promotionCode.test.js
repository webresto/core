...
describe("Promotion code integration test", function () {
    ...
    it("Base countur promocode", async () => {
        ...
        let dish1 = await Dish.createOrUpdate((0, dish_generator_1.default)({ name: "test dish for promotion", price: 10.1, concept: "road", parentGroup: groupsId[0] }));
        let dish2 = await Dish.createOrUpdate((0, dish_generator_1.default)({ name: "test fish for promotion", price: 15.2, concept: "road", parentGroup: groupsId[0] }));
