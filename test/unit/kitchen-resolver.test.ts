...
describe("kitchen-resolver", function () {
  ...
  const center = { id: "center", isCookingPoint: true, enable: true, coordinate: { lat: 56.84, lon: 60.61 } };
  const north = { id: "north", isCookingPoint: true, enable: true, coordinate: { lat: 56.92, lon: 60.61 } };
