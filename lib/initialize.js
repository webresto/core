...
module.exports = function ToInitialize(sails) {
  ...
  return function initialize(cb) {
    ...
    sails.after(eventsToWaitFor, require('@webresto/core/lib/afterHook')(sails));
    ...
    // RMS.getInstance(conf[conf.rmsAdapter], conf.timeSyncMenu, conf.timeSyncBalance, conf.timeSyncStreets);
