...
export const adminPanelModules: AdminPanelModule[] = [
  ...
  },
  {
    ...
    routes: [{ method: "get", route: "/core/orders-report/data", controller: "src/controller/get-orders-report-data" }],
  },
  {
  ...
  },
  {
    ...
    id: "tags-editor",
    routes: [{ method: "get", route: "/core/tags", controller: "src/controller/get-dish-tags" }],
  },
  {
  ...
  },
  {
    ...
    // global action (see `lib/adminpanel/models/bind.ts`) pointing at the form
 ...
 */
export const adminPanelDashboardWidgets: string[] = ["dish-count", "order-count", "dishes-on-stop", "sales-channels-count", "setup-checklist-status_0"];
...
export function adminPanelPages(): AdminPanelPage[] {
  return adminPanelModules.map((module) => module.page).filter((page): page is AdminPanelPage => Boolean(page));
}
