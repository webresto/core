...
|  checkType | String | **optional**<p>Говорит о том каким образом проверять стоимость доставки (rms - с помощью IIKO, native - встроенной функцией, тогда требуется настройка поля GeocodeConfig)</p>|
|  GeocodeConfig | JSON | **optional**<p>Настройка для карт если использовать нативную проверку</p>|
